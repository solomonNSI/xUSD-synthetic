...
export function MintBurnTipCard() {
  ...
  if (!show) return null;
  return (
<div className="relative px-3 py-3 w-72 bg-red-500 shadow-lg rounded opacity-95">
  <h2 className="text-white sm:text-lg">Mint or Burn xUSD!</h2>
  <div className="flex items-end justify-between">
    <p className="text-white mt-1.5 text-xs sm:text-sm max-w-[70%]">
      some smart text {/* Todo */}
    </p>
    <a
      href={links.github}
      target="_blank"
